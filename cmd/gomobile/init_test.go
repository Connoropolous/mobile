...
go install -x github.com/Connoropolous/mobile/gl
go install -x github.com/Connoropolous/mobile/app
go install -x github.com/Connoropolous/mobile/exp/app/debug{{end}}
